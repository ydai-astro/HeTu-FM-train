...
class SimpleFPN_super_1(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg: MultiConfig = None,frozen=False) -> None:
    ...
    def forward(self, input: Tensor) -> tuple:
        ...
        """
        # build FPN
        # print(input.shape,"jksjfklskfl")torch.Size([4, 768, 64, 64]) jksjfklskfl
        inputs = []
...
@MODELS.register_module()
class SimpleFPN_super_2(BaseModule):
    """Simple Feature Pyramid Network for ViTDet."""
...
@MODELS.register_module()
class SimpleFPN_super_3(BaseModule):
    """Simple Feature Pyramid Network for ViTDet."""
...
@MODELS.register_module()
class SimpleFPN_super_4(BaseModule):
    """Simple Feature Pyramid Network for ViTDet."""
...
@MODELS.register_module()
class SimpleFPN_super_5(BaseModule):
    """Simple Feature Pyramid Network for ViTDet."""
