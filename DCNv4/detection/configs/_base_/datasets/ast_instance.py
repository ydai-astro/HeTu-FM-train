...
data_root = '/dev/shm/AI4Astronomy_v4/'
#data_root = '/inspire/qb-ilm/project/qproject-assement/zhangkaipeng-24043/ast/DCNv4/detection/AI4Astronomy_v4/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/Astronomy_instances_train_v1.json',
